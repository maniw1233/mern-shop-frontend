    ...
    createRoutesFromElements(
      <>
        ...
        <Route
          path="/"
          element={
            !loggedInUser ? <Navigate to="/login" /> : <Navigate to={loggedInUser.isAdmin ? "/admin/dashboard" : "/"} />
          }
        />
        ...
        {loggedInUser?.isAdmin ? (
          ...
          <>
            <Route
              ...
              element={<Protected><AdminDashboardPage /></Protected>}
            />
            <Route
            ...
            <Route
              ...
              element={<Protected><AddProductPage /></Protected>}
            />
            <Route
              path="/admin/orders"
